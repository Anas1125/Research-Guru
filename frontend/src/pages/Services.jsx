...
function Services() {
    ...
    const loadPageData = async () => {
      try {
        ...
        if (settingsResponse.ok) {
          ...
          setServicesBackground(settings.services_background || "");
        }
  ...
  const implementationCategory = categories.find(
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 transition-colors duration-300 dark:bg-[#0B1220] dark:text-slate-100">
      ...
      <section
        ...
        style={{
          backgroundImage: servicesBackground
            ? `url("${getImageUrl(servicesBackground)}")`
            : "linear-gradient(to bottom right, #ffffff, #F8FAFE, #EAF1FA)",
        }}
      >
        {servicesBackground && (
          <div className="absolute inset-0 bg-gradient-to-r from-white/90 via-white/75 to-white/45 dark:from-[#0B1220]/90 dark:via-[#0B1220]/75 dark:to-[#0B1220]/45" />
        )}

        {!servicesBackground && (
          <div className="absolute inset-0 bg-gradient-to-br from-white via-[#F8FAFE] to-[#EAF1FA] dark:from-[#0B1220] dark:via-[#0F172A] dark:to-[#111B2E]" />
        )}
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 lg:py-32">
          <div className="max-w-4xl">
            ...
            <p className="mt-7 max-w-3xl text-lg leading-8 text-slate-600 dark:text-slate-300 md:text-xl">
              From Academic Writing and Publication
              support to Technical Implementation and
              Research Analysis, Reserch Guru helps
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 rounded-full border border-[#CBD7E6] bg-white/90 px-6 py-3.5 font-semibold text-[#17213A] backdrop-blur transition hover:border-[#17213A] dark:border-white/15 dark:bg-[#111B2E]/90 dark:text-white dark:hover:border-blue-400"
              >
      ...
      {/* TRUST STRIP */}
      <section className="border-b border-slate-100 bg-white dark:border-white/10 dark:bg-[#0B1220]">
        <div className="mx-auto grid max-w-7xl divide-y divide-slate-200 dark:divide-white/10 sm:grid-cols-2 sm:divide-x sm:divide-y-0 lg:grid-cols-4">
          {[
            ...
            return (
              ...
              >
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#EEF4FA] text-[#17213A] dark:bg-[#111B2E] dark:text-blue-400">
                  <Icon size={20} />
                </div>
      ...
      <section
        ...
        className="bg-[#F5F8FC] px-6 py-24 dark:bg-[#0F172A] lg:py-20"
      >
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600 dark:text-slate-300">
              Explore our main research support areas
              and the specific services available under
              each category.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <>
                  ...
                  return (
                    <button
                      ...
                      className={`group cursor-pointer rounded-[2rem] border p-8 text-left transition duration-300 ${
                        active
                          ? "border-[#17213A] bg-[#17213A] shadow-xl shadow-[#17213A]/15 dark:border-blue-500 dark:bg-[#111B2E] dark:shadow-blue-900/20"
                          : "border-[#DCE5F0] bg-white hover:-translate-y-1 hover:shadow-xl hover:shadow-[#17213A]/8 dark:border-white/10 dark:bg-[#111B2E] dark:hover:border-white/20 dark:hover:shadow-black/20"
                      }`}
                    >
                      <div
                        className={`flex h-14 w-14 items-center justify-center rounded-2xl ${
                          active
                            ? "bg-white text-[#17213A] dark:bg-blue-500 dark:text-white"
              ...
              {activeData && (
                <div className="mt-6 overflow-hidden rounded-[2rem] border border-[#DCE5F0] bg-white shadow-sm dark:border-white/10 dark:bg-[#111B2E]">
                  <div className="grid lg:grid-cols-[0.85fr_1.15fr]">
                    {/* CONTENT */}
                    <div className="bg-[#17213A] p-8 text-white dark:bg-[#070D18] md:p-10">
                      <p className="text-xs font-bold tracking-[0.22em] text-slate-300">
                        {activeData.name === "Implementation"
                          ? "TECHNICAL RESEARCH IMPLEMENTATION"
                          : activeData.name === "Writing"
                          ? "ACADEMIC & RESEARCH WRITING"
                          : activeData.name === "Publication"
                    ...
                    <div className="p-8 md:p-10">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <h3 className="mt-2 text-2xl font-bold text-[#17213A] dark:text-white">
                            {activeData.name}
                          </h3>
                        </div>

                        <div className="hidden h-12 w-12 items-center justify-center rounded-2xl bg-[#EEF4FA] text-[#17213A] dark:bg-[#0F172A] dark:text-blue-400 sm:flex">
                          {(() => {
                        ...
                        {(activeData.services || [])
                          ...
                          .map((service) => (
                            <Link
                              ...
                              key={service.id}
                              className="group rounded-2xl border border-[#DCE5F0] bg-[#F8FAFC] p-5 transition hover:border-[#17213A] hover:bg-white hover:shadow-sm dark:border-white/10 dark:bg-[#0F172A] dark:hover:border-blue-500 dark:hover:bg-[#111B2E]"
                            >
                              <div className="flex items-start justify-between gap-4">
                                <div>
                                  <h4 className="font-semibold text-[#17213A] dark:text-white">
                                    {service.name}
                                  </h4>
                                ...
                                <ArrowRight
                                  size={17}
                                  className="mt-1 shrink-0 text-slate-400 transition group-hover:translate-x-1 group-hover:text-[#17213A] dark:group-hover:text-blue-400"
                                />
                              </div>
                            </Link>
                          ))}
      ...
      {/* WHAT YOU RECEIVE */}
      <section className="bg-white px-6 py-24 dark:bg-[#0B1220] lg:py-15">
        <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600 dark:text-slate-300">
              ...
              Methodology, Technology, and Expected
              Outcomes. Our Services are structured so
              that support can be aligned with the stage
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {receiveItems.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="rounded-3xl border border-[#DCE5F0] bg-[#F8FAFC] p-6 dark:border-white/10 dark:bg-[#111B2E]"
                >
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-white text-[#17213A] shadow-sm dark:bg-[#0F172A] dark:text-blue-400">
                    <Icon size={20} />
                  </div>
      ...
      {/* BLOG */}
      <section className="bg-[#F5F8FC] px-6 py-24 dark:bg-[#0F172A] lg:py-20">
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 text-lg leading-8 text-slate-600 dark:text-slate-300">
                ...
                Perspectives, Publication Information,
                and Practical Insights for Scholars.
              </p>
            </div>

            <Link
              to="/blog"
              className="inline-flex shrink-0 items-center gap-2 font-semibold text-[#17213A] dark:text-blue-400"
            >
              View All Articles
              <ArrowRight size={18} />
            </Link>
          ...
          {blogsLoading ? (
            <div className="mt-14 rounded-3xl border border-[#DCE5F0] bg-white p-12 text-center dark:border-white/10 dark:bg-[#111B2E]">
              <div className="mx-auto h-6 w-6 animate-spin rounded-full border-2 border-slate-300 border-t-[#17213A] dark:border-slate-600 dark:border-t-blue-400" />
            ...
            <div className="mt-14 rounded-3xl border border-[#DCE5F0] bg-white p-12 text-center dark:border-white/10 dark:bg-[#111B2E]">
              <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[#EEF4FA] text-[#17213A] dark:bg-[#0F172A] dark:text-blue-400">
                <BookOpen size={24} />
              </div>
              ...
              <p className="mt-2 text-slate-500 dark:text-slate-400">
                Published research insights will appear
                here.
              </p>
            </div>
          ) : (
            <div className="mt-12 flex gap-6 overflow-x-auto pb-4 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden lg:grid lg:grid-cols-3 lg:overflow-visible lg:pb-0">
              {blogs.map((blog) => {
                ...
                return (
                  <article
                    key={blog.id}
                    className="group w-[85%] shrink-0 overflow-hidden rounded-3xl border border-[#DCE5F0] bg-white transition duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-[#17213A]/8 dark:border-white/10 dark:bg-[#111B2E] dark:hover:shadow-black/20 lg:w-auto lg:shrink"
                  >
                    <div className="h-56 overflow-hidden bg-[#EAF1FA] dark:bg-[#0F172A]">
                      {imageUrl ? (
                        <img
                          src={imageUrl}
                          alt={blog.title}
                        ...
                        <div className="flex h-full items-center justify-center bg-gradient-to-br from-[#EAF1FA] to-[#F5F8FC] dark:from-[#111B2E] dark:to-[#0F172A]">
                          <BookOpen
                            size={42}
                            strokeWidth={1.5}
                    ...
                    <div className="p-7">
                      {blog.category && (
                        <span className="text-xs font-bold uppercase tracking-[0.16em] text-[#17213A] dark:text-blue-400">
                          {blog.category}
                        </span>
                      )}

                      <h3 className="mt-3 text-xl font-bold leading-snug text-[#17213A] dark:text-white">
                        {blog.title}
                      </h3>
                      ...
                      <div className="mt-5 flex flex-wrap items-center gap-5 text-xs text-slate-500 dark:text-slate-400">
                      ...
                      <Link
                        to={`/blog/${blog.slug}`}
                        className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-[#17213A] dark:text-blue-400"
                      >
                        Read Article
      ...
      {/* RESEARCH DOMAINS */}
      <section className="bg-[#F5F8FC] px-6 py-24 dark:bg-[#0F172A] lg:py-15">
        <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.75fr_1.25fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-bold tracking-tight text-[#17213A] dark:text-white md:text-5xl">
              Implementation Support Across Research
              Disciplines.
            </h2>

            <p className="mt-5 text-lg leading-8 text-slate-600 dark:text-slate-300">
              Our implementation services can be adapted
              to the research domains and requirements
              managed through our service platform.
            </p>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {implementationDomains.length > 0 ? (
              implementationDomains
                ...
                .map((domain) => (
                  <Link
                    ...
                    className="group flex items-center justify-between gap-3 rounded-2xl border border-[#DCE5F0] bg-white px-5 py-4 transition hover:border-[#17213A] hover:bg-[#F8FAFC] dark:border-white/10 dark:bg-[#111B2E] dark:hover:border-blue-500 dark:hover:bg-[#162238]"
                  >
              ...
              <div className="rounded-2xl border border-[#DCE5F0] bg-white p-6 text-sm text-slate-500 dark:border-white/10 dark:bg-[#111B2E] dark:text-slate-400 sm:col-span-2">
                No implementation domains are currently
                available.
              </div>
            )}
          </div>
      ...
      {clients.length > 0 && (
        <section className="bg-[#F5F8FC] py-10 dark:bg-[#0F172A]">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto mb-10 max-w-3xl text-center">
              <p className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#17213A] dark:text-blue-400">
                Publication Partners
              </p>

              <h2 className="text-3xl font-bold tracking-tight text-[#17213A] dark:text-white sm:text-4xl">
                Publishers & Journals We Work With
              </h2>

              <p className="mt-4 text-base leading-7 text-slate-600 dark:text-slate-300">
                Supporting researchers with publication
                across leading academic publishers and
                journals.
              </p>
            </div>
                  ...
                  <div className="publisher-marquee-track">
                    {[...clients, ...clients].map(
                      (client, index) => (
                        <div
                          key={`${client.id}-${index}`}
                          className="group flex h-[190px] w-[240px] shrink-0 flex-col items-center justify-center rounded-2xl border border-slate-200 bg-white px-6 py-6 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-md dark:border-white/10 dark:bg-[#111B2E] dark:hover:shadow-black/20 sm:w-[260px]"
                        >
                          {client.logo_url && (
                          ...
                          <p className="mt-5 text-center text-base font-semibold text-[#17213A] dark:text-white">
                            {client.name}
                          </p>
                        </div>
                      )
      ...
      {/* PROCESS */}
      <section className="bg-white px-6 py-24 dark:bg-[#0B1220] lg:py-20">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <span className="text-sm font-semibold uppercase tracking-[0.2em] text-[#17213A] dark:text-blue-400">
              Our Process
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600 dark:text-slate-300">
              A clear process helps us understand what the
              project needs before the actual work begins.
            </p>
          </div>
          ...
          <div className="mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {processSteps.map((step) => {
              ...
              return (
                <div
                  key={step.number}
                  className="rounded-3xl border border-[#DCE5F0] bg-[#F8FAFC] p-7 dark:border-white/10 dark:bg-[#111B2E]"
                >
                  <div className="flex items-center justify-between">
      ...
      <section className="bg-[#F5F8FC] px-6 py-24 dark:bg-[#0F172A] lg:py-20">
        <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-bold tracking-tight text-[#17213A] dark:text-white md:text-5xl">
              Move From Completed Research To
              Publication-Ready Work.
            </h2>

            <p className="mt-5 text-lg leading-8 text-slate-600 dark:text-slate-300">
              Publication involves decisions about
              Journal Scope, Manuscript Structure,
              Formatting, Presentation, and Submission.
              Our Publication support is designed to help
              researchers organize these requirements
              more effectively.
            </p>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div
                  key={item}
                  className="flex items-center gap-3 rounded-xl bg-white px-4 py-3.5 dark:bg-[#111B2E]"
                >
                  <CheckCircle2
                    size={18}
                    className="shrink-0 text-[#17213A] dark:text-blue-400"
          ...
          <div className="rounded-[2rem] border border-[#DCE5F0] bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#111B2E] md:p-10">
            ...
            <p className="mt-4 leading-7 text-slate-600 dark:text-slate-300">
              A publication strategy should begin with
              understanding the Research Contribution,
              Intended Audience, Journal Scope, and
              Submission Requirements.
            </p>

            <Link
              to="/contact?service=Publication"
              className="mt-7 inline-flex items-center gap-2 font-semibold text-[#17213A] dark:text-blue-400"
            >
              Discuss Publication
              <ArrowRight size={17} />
            </Link>
          ...
          <div className="mt-12 space-y-3">
            {[
              ...
              return (
                <div
                  key={faq.question}
                  className="overflow-hidden rounded-2xl border border-[#DCE5F0] dark:border-white/10"
                >
                  <button
                    type="button"
                    onClick={() =>
                  ...
                  >
                    <span className="font-semibold text-[#17213A] dark:text-white">
                      {faq.question}
                    </span>

                    <ChevronDown
                      size={19}
                      className={`shrink-0 text-[#17213A] transition-transform dark:text-blue-400 ${
                        open ? "rotate-180" : ""
                      }`}
                    />
                  </button>
                  ...
                  {open && (
                    <div className="border-t border-[#DCE5F0] px-6 py-5 dark:border-white/10">
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-start justify-between gap-10 md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">
              Tell us where you are in your research
              journey and what kind of support you need.
            </p>
          </div>
